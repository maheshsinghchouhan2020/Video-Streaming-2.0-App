...
const DanceFloorSection = () => {
  ...
  useEffect(() => {
    const updateArrowButtonsVisibility = () => {
      const totalItems = danceFloorSectionData.length;
    ...
    <>
      <div className="custom-container">
        ...
        <Slider ref={sliderRef} {...settings} className="h-60">
          {danceFloorSectionData.map((item) => (
            <div key={item.id}>
...
export default DanceFloorSection;
