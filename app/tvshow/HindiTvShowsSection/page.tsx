...
const HindiTvShowsSection = () => {
  ...
  useEffect(() => {
    const updateArrowButtonsVisibility = () => {
      const totalItems = hindiTvShowsSectionData.length;
    ...
    <>
      <div className="custom-container">
        ...
        <Slider ref={sliderRef} {...settings} className="h-60">
          {hindiTvShowsSectionData.map((item) => (
...
export default HindiTvShowsSection;
