...
import CelebrityInterviewData from "@/app/content/tvShowData/celebrityInterviewSectionData";
...
const CelebrityInterview = () => {
  ...
  useEffect(() => {
    const updateArrowButtonsVisibility = () => {
      const totalItems = CelebrityInterviewData.length;
  ...
  return (
    <div className="custom-container">
      ...
      <Slider ref={sliderRef} {...settings} className="h-60">
        {CelebrityInterviewData.map((item) => (
