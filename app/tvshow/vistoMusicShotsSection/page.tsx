...
import VistoMusicShotsData from "@/app/content/tvShowData/vistoMusicShotsData";

const VistoMusicShots = () => {
  ...
  useEffect(() => {
    const updateArrowButtonsVisibility = () => {
      const totalItems = VistoMusicShotsData.length;
...
export default VistoMusicShots;
