...
const SerialPreviewsSection = () => {
  ...
  useEffect(() => {
    const updateArrowButtonsVisibility = () => {
      const totalItems = serialPreviewsSectionData.length;
  ...
  return (
    <div className="custom-container">
      ...
      <Slider ref={sliderRef} {...settings} className="h-60">
        {serialPreviewsSectionData.map((item) => (
...
export default SerialPreviewsSection;
